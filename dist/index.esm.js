...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#eae2fc", background: "#282340", backgroundDisabled: "#3c3742", backgroundAlt: "#3d334b", cardBorder: "#38434C", contrast: "#191326", dropdown: "#1B1E1E", dropdownDeep: "#0E1214", invertedContrast: "#191326", input: "#3B3F56", inputSecondary: "#222B51", primaryDark: "#e3e1e1", tertiary: "#353547", text: "#E1E7F9", textDisabled: "#BDC2C4", textSubtle: "#ff7e00", disabled: "#4A5160", gradients: {
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#eae2fc", background: "#18171e", backgroundDisabled: "#3c3742", backgroundAlt: "#151519", cardBorder: "#38434C", contrast: "#191326", dropdown: "#1B1E1E", dropdownDeep: "#0E1214", invertedContrast: "#191326", input: "#3B3F56", inputSecondary: "#222B51", primaryDark: "#e3e1e1", tertiary: "#353547", text: "#E1E7F9", textDisabled: "#BDC2C4", textSubtle: "#ff7e00", disabled: "#4A5160", gradients: {
        bubblegum: "linear-gradient(139.73deg, #31475B 0%, #272B35 100%)",
        inverseBubblegum: "linear-gradient(139.73deg, #272B35 0%, #31475B 100%)",
        cardHeader: "linear-gradient(166.77deg, #31475B 0%, #3A3045 100%)",
        blue: "linear-gradient(180deg, #31475B 0%, #4A5160 100%)",
...
var Logo$2 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React.createElement("image", { width: "205", height: "26", href: isDark ? '/images/egg/LogoTextNewWhite.svg' : '/images/egg/LogoTextNewWhite.svg' })));
};
...
var socials = [
    {
        ...
        items: [
            {
                label: "English",
                href: "https://t.me/jaguararbitrum",
            },
        ],
    },
    {
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "https://jaguarswap.gitbook.io/jaguar-on-arbitrum/security/contracts", target: "_blank" },
